...
export default function PlaceSearch({ onPlaceSelect }: PlaceSearchProps) {
  ...
  return (
    <div className="relative">
      <label className="block text-sm font-medium mb-1">場所を検索 *</label>
      <input
        type="text"
        value={query}
      ...
      {suggestions.length > 0 && (
        <ul className="absolute z-50 w-full bg-white border rounded-b shadow-lg max-h-60 overflow-y-auto">
